...
<div class="page-wrapper">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="nav-dropdown"><a href="#" title="Positions"><i class="fa fa-lg fa-fw fa-bank"></i> Automation</a>
                            <ul class="nav-sub">                                
                                ...
                                <%--<li><a href='<%: Url.Action("getdata", "Member")%>' title="Harvest"><i class="fa fa-lg fa-fw fa-leaf"></i> Pull Data</a></li>                                                  
                                <li><a href='<%: Url.Action("displaydata", "Member", New With {.sym = "GDX", .wid = 0.25, .viewdate = Today.Date})%>' title="Harvest"><i class="fa fa-lg fa-fw fa-leaf"></i> View Data</a></li>--%>
                                <% If User.Identity.Name.ToUpper = "CSQUARED20" Then%>                                                    
                                    <%--<li><a href='<%: Url.Action("SuperFly", "Member")%>' title="SuperFly"><i class="fa fa-lg fa-fw fa-paper-plane"></i> Super-Fly</a></li>--%>
                                    <%--<li><a href='<%: Url.Action("SuperFly", "Member")%>' title="SuperFly"><i class="fa fa-lg fa-fw fa-paper-plane"></i> The Strangle</a></li>--%>
                                    <%--<li><a href='<%: Url.Action("SuperFly", "Member")%>' title="SuperFly"><i class="fa fa-lg fa-fw fa-paper-plane"></i> Harvesting</a></li>--%>
        ...
        <div class="page-content">           
            ...
            <h1>Back Data Processing</h1>
            <div class="col-md-12"  style="margin-top: 30px; margin-left: 30px;">
                <% Using Html.BeginForm("backdata", "test")%>
                    <div class="row">       
                        <input style="margin-left: 10px; margin-right: 20px; width: 75px; height: 100%;" type="text" id="symbol" name="symbol" class="form-control col-md-1" placeholder="VXX" />                                                                                                                                                          
                        <input style="margin-left: 5px; margin-right: 20px; width: 100px; height: 100%;" type="text" id="filename" name="filename" class="form-control col-md-2" placeholder="YYYYMMDD" />
                    </div>             
                    <div class="row">                                                                   
                        <button style="margin-left: 10px; margin-bottom: 50px; margin-top: 25px;" class="btn btn-primary col-md-2" id="backdate" value="backdate">Load Back Data</button>
                        <br />                                         
                        <%--<%: ViewData("status")%>--%>
                    </div>    
                <% End Using%>     
