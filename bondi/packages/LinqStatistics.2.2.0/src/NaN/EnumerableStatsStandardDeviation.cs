...
namespace LinqStatistics.NaN
{
    public static partial class EnumerableStats
    {
        ...
        public static double StandardDeviationNaN(this IEnumerable<int> source)
        {
            return (double)Math.Sqrt((double)source.VarianceNaN());
        }
        ...
        ///     The StandardDeviation of the sequence of values.
        /// </returns>
        public static double? StandardDeviationNaN<TSource>(this IEnumerable<TSource> source, Func<TSource, int?> selector)
        {
            if (source == null)
        ...
        ///     The StandardDeviation of the sequence of values.
        /// </returns>
        public static double? StandardDeviationNaN<TSource>(this IEnumerable<TSource> source, Func<TSource, long?> selector)
        {
            if (source == null)
                throw new ArgumentNullException("source");
        ...
        public static float StandardDeviationNaN(this IEnumerable<float> source)
        {
            return (float)Math.Sqrt((double)source.VarianceNaN());
        }
        ...
        ///     The StandardDeviation of the sequence of values.
        /// </returns>
        public static float? StandardDeviationNaN<TSource>(this IEnumerable<TSource> source, Func<TSource, float?> selector)
        {
            if (source == null)
                throw new ArgumentNullException("source");
