    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="page-subheading page-subheading-md">
                <ol class="breadcrumb"><li class="active"><a href="javascript:;"> Edit Control Card</a></li></ol>
            </div>
                        ...
                        <div class="col-md-8">                
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="control-label" for="experimentTrigger">Buy Trigger</label>
                                            <input type="text" class="form-control" id="exptrigger" placeholder="0.25">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="control-label" for="experimentWidth">Sell Trigger</label>
                                            <input type="text" class="form-control" id="expwidth" placeholder="0.25">
                                        </div>
                                    </div>
                                </div>
