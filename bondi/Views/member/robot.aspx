    ...
    <div class="page-wrapper">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="nav-dropdown active open"><a href="#" title="automation"><i class="fa fa-lg fa-fw fa-gears"></i> Automation</a>
                        <ul class="nav-sub">
                            ...
                            <li class="active"><a href='<%: Url.Action("IBtest", "Member")%>'><i class="fa fa-lg fa-fw fa-caret-right"></i> Harvest Robot "Willie"</a></li>
        ...
        <div class="page-content">
            <div class="page-subheading page-subheading-md">
                <ol class="breadcrumb"><li class="active"><a href="javascript:;"> Harvest Robot - Willie </a></li></ol>
            </div>
            ...
            <div class="container-fluid-md">
                ...
                </div>                                                                                                                      <%--  RESULTS OF ROBOT RUN POSTED HERE --%>
