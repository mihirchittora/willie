        ...
        <div class="container">
            <div class="panel panel-default form-container">
                <div class="panel-body">
                    <form role="form">
                        <h3 class="text-center margin-xl-bottom">We all forget things...</h3>
                        ...
                        <a href="index.html" class="btn btn-primary btn-block btn-lg">SUBMIT</a>
                    </form>
                </div>
                <div class="panel-body text-center">
                    <div class="margin-bottom">
                        <a class="text-muted text-underline" href='<%: Url.Action("logon", "account")%>'>Sign In</a>
                    </div>
                    <div>
