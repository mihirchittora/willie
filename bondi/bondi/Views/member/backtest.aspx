                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <form class="form-inline" role="form">
                                        ...
                                        <%--<button type="submit" id="stopBot" name="stopBot" class="btn btn-danger col-sm-1 pull-right">Stop Bot </button>--%>
                                        <button type="submit" id="getData" name="getData" class="btn btn-primary col-sm-2 pull-right" style="margin-right: 10px; margin-top: 5px;">Start Bot </button>
