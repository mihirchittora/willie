                                ...
                                <div class="panel panel-default" style="height: 468px;">
                                    ...
                                    <div class="panel-body">
                                        <div class="metric-content metric-icon">                       
                                            ...
                                            <span class="chart" data-percent="21.7">
                                ...
                                <div class="panel panel-default" style="height: 468px;">
                                    ...
                                    <div class="panel-body ">
                                        <div class="metric-content metric-icon">                       
                                            ...
                                            <h5>Status:   <span style="float: right; padding-right: 10px;"><%: ViewData("connected")%></span></h5> <br />
                                            <h5>Active orders:   <span style="float: right; padding-right: 10px;"><%: ViewData("Message")%></span></h5>
